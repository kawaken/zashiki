...
pub fn run(gpa_alloc: std.mem.Allocator) !u8 {
    ...
    if (resources_dir == null)
        try stderr.print("Could not find the Zashiki resources directory. Please ensure " ++
            "that Zashiki is installed correctly.\n", .{});
...
const Preview = struct {
    ...
    pub fn run(self: *Preview) !void {
        ...
        try self.vx.setTitle(writer, "👻 Zashiki Theme Preview 👻");
        ...
        switch (self.mode) {
            ...
            .save => {
                ...
                const save_instructions = [_][]const u8{
                    "To apply this theme, add the following line to your Zashiki configuration:",
                    "",
                    ...
                    "Then add the following line to your Zashiki configuration and reload:",
                    "",
