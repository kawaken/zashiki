...
class MockConfig: Zashiki.Config {
    internal init(backgroundBlur: Zashiki.Config.BackgroundBlur, backgroundColor: Color, backgroundOpacity: Double) {
    ...
    var _backgroundBlur: Zashiki.Config.BackgroundBlur
    var _backgroundColor: Color
    var _backgroundOpacity: Double

    override var backgroundBlur: Zashiki.Config.BackgroundBlur {
        _backgroundBlur
    }
...
struct TerminalViewContainerTests {
    @Test func glassAvailability() async throws {
        ...
        await view.zashikiConfigDidChange(config, preferredBackgroundColor: nil)
    ...
    @Test func configChangeUpdatesGlass() async throws {
        ...
        await view.zashikiConfigDidChange(config1, preferredBackgroundColor: nil)
        ...
        await view.zashikiConfigDidChange(config1, preferredBackgroundColor: .red)
        ...
        // This won't change, unless zashikiConfigDidChange is called
        #expect(effectView.cornerRadius == 0)
        ...
        await view.zashikiConfigDidChange(config2, preferredBackgroundColor: .red)
