...
struct ConfigTests {
    ...
    @Test(arguments: [
        ("always", Zashiki.Config.ResizeOverlay.always),
        ("never", Zashiki.Config.ResizeOverlay.never),
        ("after-first", Zashiki.Config.ResizeOverlay.after_first),
    ])
    func resizeOverlayValues(raw: String, expected: Zashiki.Config.ResizeOverlay) throws {
