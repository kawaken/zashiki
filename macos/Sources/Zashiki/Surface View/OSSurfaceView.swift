...
extension Zashiki {
    class OSSurfaceView: OSView, ObservableObject {
        ...
        init(id: UUID?, frame: CGRect) {
            ...
            center.addObserver(
                self,
                selector: #selector(zashikiDidChangeReadonly(_:)),
        ...
        @objc private func zashikiDidChangeReadonly(_ notification: Foundation.Notification) {
...
extension Zashiki.OSSurfaceView {
    @MainActor class SearchState: ObservableObject {
        ...
        init(
            from startSearch: Zashiki.Action.StartSearch,
