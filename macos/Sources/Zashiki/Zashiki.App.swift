...
protocol ZashikiAppDelegate: AnyObject {
    #if os(macOS)
...
extension Zashiki {
    ...
    // This is a refactor/redo of Zashiki.AppState so that it supports both macOS and iOS
    class App: ObservableObject {
        ...
        /// Optional delegate
        weak var delegate: ZashikiAppDelegate?
        ...
        func openConfig() {
            let str = configPath ?? Zashiki.AllocatedString(ghostty_config_open_path()).string
        ...
        func reloadConfig(soft: Bool = false) {
            ...
            guard newConfig.loaded else {
                Zashiki.logger.warning("failed to reload configuration")
                return
            }
        ...
        // Called when the selected keyboard changes. We have to notify Zashiki so that
        ...
        // MARK: Zashiki Callbacks (macOS)

        static func closeSurface(_ userdata: UnsafeMutableRawPointer?, processAlive: Bool) {
            let surface = self.surfaceUserdata(from: userdata)
            NotificationCenter.default.post(name: Notification.zashikiCloseSurface, object: surface, userInfo: [
        ...
        static func confirmReadClipboard(
            ...
            guard let request = Zashiki.ClipboardRequest.from(request: request) else { return }
        ...
        static func writeClipboard(
            ...
            let contentArray = (0..<len).compactMap { i in
                Zashiki.ClipboardContent.from(content: content[i])
            }
            ...
            NotificationCenter.default.post(
                ...
                userInfo: [
                    ...
                    Notification.ConfirmClipboardRequestKey: Zashiki.ClipboardRequest.osc_52_write(pasteboard),
                ]
            )
        }
        ...
        /// Determine if a given notification should be presented to the user when Zashiki is running in the foreground.
        ...
        /// Returns the ZashikiState from the given userdata value.
        ...
        static func action(_ app: ghostty_app_t, target: ghostty_target_s, action: ghostty_action_s) -> Bool {
            ...
            default:
                Zashiki.logger.warning("unknown action target=\(target.tag.rawValue, privacy: .public)")
                return false
            }
            ...
            default:
                Zashiki.logger.warning("unknown action action=\(action.tag.rawValue, privacy: .public)")
                return false
            }
        ...
        private static func openURL(
            ...
            let action = Zashiki.Action.OpenURL(c: v)
        ...
        private static func newWindow(_ app: ghostty_app_t, target: ghostty_target_s) {
            ...
            case GHOSTTY_TARGET_APP:
                NotificationCenter.default.post(
                    name: Notification.zashikiNewWindow,
                    object: nil,
                    userInfo: [:]
                )
        ...
        private static func newSplit(
            ...
            case GHOSTTY_TARGET_APP:
                ...
                Zashiki.logger.warning("new split does nothing with an app target")
                return
            ...
            case GHOSTTY_TARGET_SURFACE:
                ...
                NotificationCenter.default.post(
                    name: Notification.zashikiNewSplit,
                    object: surfaceView,
                    userInfo: [
                        "direction": direction,
        ...
        private static func presentTerminal(
            ...
            case GHOSTTY_TARGET_SURFACE:
                ...
                NotificationCenter.default.post(
                    name: Notification.zashikiPresentTerminal,
                    object: surfaceView
                )
                return true
        ...
        private static func closeTab(_ app: ghostty_app_t, target: ghostty_target_s, mode: ghostty_action_close_tab_mode_e) {
            switch target.tag {
            case GHOSTTY_TARGET_APP:
                Zashiki.logger.warning("close tabs does nothing with an app target")
                return
        ...
        private static func closeWindow(_ app: ghostty_app_t, target: ghostty_target_s) {
            switch target.tag {
            case GHOSTTY_TARGET_APP:
                Zashiki.logger.warning("close window does nothing with an app target")
                return
        ...
        private static func toggleFullscreen(
            ...
            switch target.tag {
            case GHOSTTY_TARGET_APP:
                Zashiki.logger.warning("toggle fullscreen does nothing with an app target")
                return
            ...
            case GHOSTTY_TARGET_SURFACE:
                ...
                guard let mode = FullscreenMode.from(ghostty: raw) else {
                    Zashiki.logger.warning("unknown fullscreen mode raw=\(raw.rawValue, privacy: .public)")
                    return
                }
                NotificationCenter.default.post(
                    name: Notification.zashikiToggleFullscreen,
                    object: surfaceView,
                    userInfo: [
        ...
        private static func toggleCommandPalette(
            ...
            switch target.tag {
            case GHOSTTY_TARGET_APP:
                Zashiki.logger.warning("toggle command palette does nothing with an app target")
                return
        ...
        private static func toggleMaximize(
            ...
            switch target.tag {
            case GHOSTTY_TARGET_APP:
                Zashiki.logger.warning("toggle maximize does nothing with an app target")
                return
        ...
        private static func ringBell(
            ...
            case GHOSTTY_TARGET_APP:
                ...
                Zashiki.logger.warning("ring bell does nothing with an app target")
                return
        ...
        private static func selectionChanged(
            ...
            switch target.tag {
            case GHOSTTY_TARGET_APP:
                Zashiki.logger.warning("selection changed does nothing with an app target")
                return
            ...
            case GHOSTTY_TARGET_SURFACE:
                ...
                guard let surfaceView = self.surfaceView(from: surface) else { return }
                NotificationCenter.default.post(
                    name: .zashikiSelectionDidChange,
                    object: surfaceView
                )
        ...
        private static func setReadonly(
            ...
            switch target.tag {
            case GHOSTTY_TARGET_APP:
                Zashiki.logger.warning("set readonly does nothing with an app target")
                return
        ...
        private static func moveTab(
            ...
            move: ghostty_action_move_tab_s) -> Bool {
                switch target.tag {
                case GHOSTTY_TARGET_APP:
                    Zashiki.logger.warning("move tab does nothing with an app target")
                    return false
                ...
                case GHOSTTY_TARGET_SURFACE:
                    ...
                    NotificationCenter.default.post(
                        ...
                        object: surfaceView,
                        userInfo: [
                            SwiftUI.Notification.Name.ZashikiMoveTabKey: Action.MoveTab(c: move),
                        ]
                    )
        ...
        private static func gotoTab(
            ...
            tab: ghostty_action_goto_tab_e) -> Bool {
                switch target.tag {
                case GHOSTTY_TARGET_APP:
                    Zashiki.logger.warning("goto tab does nothing with an app target")
                    return false
        ...
        private static func gotoSplit(
            ...
            direction: ghostty_action_goto_split_e) -> Bool {
                switch target.tag {
                case GHOSTTY_TARGET_APP:
                    Zashiki.logger.warning("goto split does nothing with an app target")
                    return false
                ...
                case GHOSTTY_TARGET_SURFACE:
                    ...
                    let focusDirection: SplitTree<Zashiki.SurfaceView>.FocusDirection = splitDirection.toSplitTreeFocusDirection()
                    ...
                    NotificationCenter.default.post(
                        name: Notification.zashikiFocusSplit,
                        object: surfaceView,
                        userInfo: [
        ...
        private static func resizeSplit(
            ...
            resize: ghostty_action_resize_split_s) -> Bool {
                switch target.tag {
                case GHOSTTY_TARGET_APP:
                    Zashiki.logger.warning("resize split does nothing with an app target")
                    return false
        ...
        private static func equalizeSplits(
            ...
            switch target.tag {
            case GHOSTTY_TARGET_APP:
                Zashiki.logger.warning("equalize splits does nothing with an app target")
                return
        ...
        private static func toggleSplitZoom(
            ...
            switch target.tag {
            case GHOSTTY_TARGET_APP:
                Zashiki.logger.warning("toggle split zoom does nothing with an app target")
                return false
        ...
        private static func showDesktopNotification(
            ...
            switch target.tag {
            case GHOSTTY_TARGET_APP:
                Zashiki.logger.warning("desktop notification does nothing with an app target")
                return
        ...
        private static func showDesktopNotification(
            ...
            center.requestAuthorization(options: [.alert, .sound]) { _, error in
                if let error = error {
                    Zashiki.logger.error("Error while requesting notification authorization: \(error, privacy: .public)")
                }
            }
        ...
        private static func commandFinished(
            ...
            switch target.tag {
            case GHOSTTY_TARGET_APP:
                Zashiki.logger.warning("command finished does nothing with an app target")
                return
        ...
        private static func toggleFloatWindow(
            ...
            switch target.tag {
            case GHOSTTY_TARGET_APP:
                Zashiki.logger.warning("toggle float window does nothing with an app target")
                return
        ...
        private static func toggleBackgroundOpacity(
            ...
            switch target.tag {
            case GHOSTTY_TARGET_APP:
                Zashiki.logger.warning("toggle background opacity does nothing with an app target")
                return
        ...
        private static func setTitle(
            ...
            switch target.tag {
            case GHOSTTY_TARGET_APP:
                Zashiki.logger.warning("set title does nothing with an app target")
                return
        ...
        private static func setTabTitle(
            ...
            switch target.tag {
            case GHOSTTY_TARGET_APP:
                Zashiki.logger.warning("set tab title does nothing with an app target")
                return false
        ...
        private static func promptTitle(
            ...
            case .surface:
                switch target.tag {
                case GHOSTTY_TARGET_APP:
                    Zashiki.logger.warning("set title prompt does nothing with an app target")
                    return false
        ...
        private static func pwdChanged(
            ...
            switch target.tag {
            case GHOSTTY_TARGET_APP:
                Zashiki.logger.warning("pwd change does nothing with an app target")
                return
        ...
        private static func setMouseShape(
            ...
            switch target.tag {
            case GHOSTTY_TARGET_APP:
                Zashiki.logger.warning("set mouse shapes nothing with an app target")
                return
        ...
        private static func setInitialSize(
            ...
            switch target.tag {
            case GHOSTTY_TARGET_APP:
                Zashiki.logger.warning("initial size does nothing with an app target")
                return
        ...
        private static func resetWindowSize(
            ...
            switch target.tag {
            case GHOSTTY_TARGET_APP:
                Zashiki.logger.warning("reset window size does nothing with an app target")
                return
        ...
        private static func keySequence(
            ...
            switch target.tag {
            case GHOSTTY_TARGET_APP:
                Zashiki.logger.warning("key sequence does nothing with an app target")
                return
        ...
        private static func keyTable(
            ...
            switch target.tag {
            case GHOSTTY_TARGET_APP:
                Zashiki.logger.warning("key table does nothing with an app target")
                return

            case GHOSTTY_TARGET_SURFACE:
                guard let surface = target.target.surface else { return }
                guard let surfaceView = self.surfaceView(from: surface) else { return }
                guard let action = Zashiki.Action.KeyTable(c: v) else { return }
        ...
        private static func progressReport(
            ...
            switch target.tag {
            case GHOSTTY_TARGET_APP:
                Zashiki.logger.warning("progress report does nothing with an app target")
                return
            ...
            case GHOSTTY_TARGET_SURFACE:
                ...
                guard config.progressStyle else {
                    Zashiki.logger.debug("progress_report action blocked by config")
                ...
                let progressReport = Zashiki.Action.ProgressReport(c: v)
                DispatchQueue.main.async {
        ...
        private static func scrollbar(
            ...
            switch target.tag {
            case GHOSTTY_TARGET_APP:
                Zashiki.logger.warning("scrollbar does nothing with an app target")
                return
            ...
            case GHOSTTY_TARGET_SURFACE:
                ...
                let scrollbar = Zashiki.Action.Scrollbar(c: v)
                NotificationCenter.default.post(
                    name: .zashikiDidUpdateScrollbar,
                    object: surfaceView,
                    userInfo: [
        ...
        private static func startSearch(
            ...
            switch target.tag {
            case GHOSTTY_TARGET_APP:
                Zashiki.logger.warning("start_search does nothing with an app target")
                return
            ...
            case GHOSTTY_TARGET_SURFACE:
                ...
                let startSearch = Zashiki.Action.StartSearch(c: v)
                DispatchQueue.main.async {
                    if let searchState = surfaceView.searchState {
                        ...
                        surfaceView.searchState = Zashiki.SurfaceView.SearchState(from: startSearch)
                    }

                    NotificationCenter.default.post(name: .zashikiSearchFocus, object: surfaceView)
                }
        ...
        private static func endSearch(
            ...
            switch target.tag {
            case GHOSTTY_TARGET_APP:
                Zashiki.logger.warning("end_search does nothing with an app target")
                return false
        ...
        private static func searchTotal(
            ...
            switch target.tag {
            case GHOSTTY_TARGET_APP:
                Zashiki.logger.warning("search_total does nothing with an app target")
                return
        ...
        private static func searchSelected(
            ...
            switch target.tag {
            case GHOSTTY_TARGET_APP:
                Zashiki.logger.warning("search_selected does nothing with an app target")
                return
            ...
            v: ghostty_action_config_change_s) {
                ...
                case GHOSTTY_TARGET_APP:
                    ...
                    NotificationCenter.default.post(
                        ...
                        object: nil,
                        userInfo: [
                            SwiftUI.Notification.Name.ZashikiConfigChangeKey: config,
                        ]
                    )
        ...
        private static func colorChange(
            ...
            change: ghostty_action_color_change_s) {
                switch target.tag {
                case GHOSTTY_TARGET_APP:
                    Zashiki.logger.warning("color change does nothing with an app target")
                    return
                ...
                case GHOSTTY_TARGET_SURFACE:
                    ...
                    guard let surfaceView = self.surfaceView(from: surface) else { return }
                    NotificationCenter.default.post(
                        name: .zashikiColorDidChange,
                        object: surfaceView,
                        userInfo: [
                            SwiftUI.Notification.Name.ZashikiColorChangeKey: Action.ColorChange(c: change)
                        ]
                    )
        ...
        func handleUserNotification(response: UNNotificationResponse) {
            ...
            case UNNotificationDefaultActionIdentifier, Zashiki.userNotificationActionShow:
