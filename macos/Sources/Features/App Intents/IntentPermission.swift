...
/// Requests permission for Shortcuts app to interact with Zashiki
///
/// This function displays a permission dialog asking the user to allow Shortcuts
/// to interact with Zashiki. The permission is automatically cached for 10 minutes
...
/// permission for one intent allows all Zashiki intents to execute without additional
    ...
    await withCheckedContinuation { continuation in
        Task { @MainActor in
            ...
            PermissionRequest.show(
                "dev.kawaken.zashiki.shortcutsPermission",
                message: "Allow Shortcuts to interact with Zashiki?",
