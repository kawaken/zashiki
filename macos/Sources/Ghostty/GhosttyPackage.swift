...
extension Notification.Name {
    ...
    static let ghosttyConfigDidChange = Notification.Name("dev.kawaken.zashiki.configDidChange")
    static let GhosttyConfigChangeKey = ghosttyConfigDidChange.rawValue

    /// Color change. Object is the surface changing.
    static let ghosttyColorDidChange = Notification.Name("dev.kawaken.zashiki.ghosttyColorDidChange")
    static let GhosttyColorChangeKey = ghosttyColorDidChange.rawValue

    /// Goto tab. Has tab index in the userinfo.
    static let ghosttyMoveTab = Notification.Name("dev.kawaken.zashiki.moveTab")
    static let GhosttyMoveTabKey = ghosttyMoveTab.rawValue

    /// Close tab
    static let ghosttyCloseTab = Notification.Name("dev.kawaken.zashiki.closeTab")

    /// Close other tabs
    static let ghosttyCloseOtherTabs = Notification.Name("dev.kawaken.zashiki.closeOtherTabs")

    /// Close tabs to the right of the focused tab
    static let ghosttyCloseTabsOnTheRight = Notification.Name("dev.kawaken.zashiki.closeTabsOnTheRight")

    /// Close window
    static let ghosttyCloseWindow = Notification.Name("dev.kawaken.zashiki.closeWindow")

    /// Resize the window to a default size.
    static let ghosttyResetWindowSize = Notification.Name("dev.kawaken.zashiki.resetWindowSize")

    /// Ring the bell
    static let ghosttyBellDidRing = Notification.Name("dev.kawaken.zashiki.ghosttyBellDidRing")

    /// The active selection changed
    static let ghosttySelectionDidChange = Notification.Name("dev.kawaken.zashiki.ghosttySelectionDidChange")

    /// Readonly mode changed
    static let ghosttyDidChangeReadonly = Notification.Name("dev.kawaken.zashiki.didChangeReadonly")
    static let ReadonlyKey = ghosttyDidChangeReadonly.rawValue + ".readonly"
    static let ghosttyCommandPaletteDidToggle = Notification.Name("dev.kawaken.zashiki.commandPaletteDidToggle")

    /// Toggle maximize of current window
    static let ghosttyMaximizeDidToggle = Notification.Name("dev.kawaken.zashiki.maximizeDidToggle")

    /// Notification sent when scrollbar updates
    static let ghosttyDidUpdateScrollbar = Notification.Name("dev.kawaken.zashiki.didUpdateScrollbar")
    static let ScrollbarKey = ghosttyDidUpdateScrollbar.rawValue + ".scrollbar"

    /// Focus the search field
    static let ghosttySearchFocus = Notification.Name("dev.kawaken.zashiki.searchFocus")
}
...
extension Ghostty.Notification {
    ...
    static let ghosttyNewSplit = Notification.Name("dev.kawaken.zashiki.newSplit")

    /// Close the calling surface.
    static let ghosttyCloseSurface = Notification.Name("dev.kawaken.zashiki.closeSurface")

    /// Focus previous/next split. Has a SplitFocusDirection in the userinfo.
    static let ghosttyFocusSplit = Notification.Name("dev.kawaken.zashiki.focusSplit")
    static let SplitDirectionKey = ghosttyFocusSplit.rawValue

    /// Goto tab. Has tab index in the userinfo.
    static let ghosttyGotoTab = Notification.Name("dev.kawaken.zashiki.gotoTab")
    static let GotoTabKey = ghosttyGotoTab.rawValue

    /// New tab. Has base surface config requested in userinfo.
    static let ghosttyNewTab = Notification.Name("dev.kawaken.zashiki.newTab")

    /// New window. Has base surface config requested in userinfo.
    static let ghosttyNewWindow = Notification.Name("dev.kawaken.zashiki.newWindow")

    /// Present terminal. Bring the surface's window to focus without activating the app.
    static let ghosttyPresentTerminal = Notification.Name("dev.kawaken.zashiki.presentTerminal")

    /// Toggle fullscreen of current window
    static let ghosttyToggleFullscreen = Notification.Name("dev.kawaken.zashiki.toggleFullscreen")
